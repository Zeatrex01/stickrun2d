...
public class MapController : MonoBehaviour //SakuraGames

{
	...
	private void CreateGroundBlock(int startX, int startY, bool enabled){
		...
		groundBlockClone.GetComponent<Collider2D>().enabled = enabled;
		groundBlockClone.GetComponent<Renderer>().enabled = enabled;
